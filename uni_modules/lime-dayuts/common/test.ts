...
// console.log('2018-04-04', dayuts('2018-04-04T16:00:00.000Z'))
// // console.log('dayjs 2018-04-04', dayjs('2018-04-04T16:00:00.000Z'))
// console.log('2018 三月 15', dayuts('2018 三月 15', 'YYYY MMMM DD', 'zh-cn')) 
// console.log('2010, 1, 14, 15, 25, 50, 125', dayuts([2010, 1, 14, 15, 25, 50, 125])) 
// console.log('1970-00-00', dayuts('1970-00-00', 'YYYY-MM-DD'))
// console.log('1318781876406', dayuts(1318781876406))
// console.log('2018, 8, 18', dayuts(new Date(2018, 8, 18)))
// console.log('2010, 1, 14, 15, 25, 50, 125[]', dayuts([2010, 1, 14, 15, 25, 50, 125]))
