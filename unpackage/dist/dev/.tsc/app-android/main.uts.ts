...
import GenPagesReportsProductSalesClass from './pages/reports/product-sales.uvue'
...
import GenPagesCategoryFromClass from './pages/category/from.uvue'
import GenPagesShopIndexClass from './pages/shop/index.uvue'
...
import GenPagesInventoryManagementFromClass from './pages/inventory-management/from.uvue'
import GenPagesInventoryLocationsIndexClass from './pages/inventory-locations/index.uvue'
...
__uniRoutes.push({ path: "pages/reports/product-sales", component: GenPagesReportsProductSalesClass, meta: { isQuit: false } as UniPageMeta, style: _uM([["navigationStyle","custom"],["navigationBarTitleText","商品销售"]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/category/from", component: GenPagesCategoryFromClass, meta: { isQuit: false } as UniPageMeta, style: _uM([["navigationStyle","custom"],["navigationBarTitleText",""]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/shop/index", component: GenPagesShopIndexClass, meta: { isQuit: false } as UniPageMeta, style: _uM([["navigationStyle","custom"],["navigationBarTitleText",""]]) } as UniPageRoute)
...
__uniRoutes.push({ path: "pages/inventory-management/from", component: GenPagesInventoryManagementFromClass, meta: { isQuit: false } as UniPageMeta, style: _uM([["navigationStyle","custom"],["navigationBarTitleText",""]]) } as UniPageRoute)
__uniRoutes.push({ path: "pages/inventory-locations/index", component: GenPagesInventoryLocationsIndexClass, meta: { isQuit: false } as UniPageMeta, style: _uM([["navigationStyle","custom"],["navigationBarTitleText",""]]) } as UniPageRoute)
