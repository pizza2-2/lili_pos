...
type Props = { __$originalPosition?: UTSSourceMapPosition<"Props", "uni_modules/lili-UniversalList/components/lili-UniversalList/lili-UniversalList.uvue", 215, 6>;
	items?: UTSJSONObject[]
	keyField?: string
	titleField?: string
...
const __sfc__ = defineComponent({
  ...
  props: {
    ...
    summaryTitle: { type: String, required: false, default: '统计信息' },
    summaryItems: { type: Array as PropType<UTSJSONObject[]>, required: false, default: () : UTSJSONObject[] => [] },
    summaryCollapsedByDefault: { type: Boolean, required: false, default: true },
...
const batchActionMenuVisible = ref<boolean>(false)
...
function fieldHideWhenEmpty(field: UTSJSONObject) : boolean {
	const raw = field['hideWhenEmpty']
	return raw == true
}
...
function itemMenuActions(item: UTSJSONObject) : UTSJSONObject[] {
	const itemActions = parseObjectArray(item['menuActions'])
...
function fieldVisible(item: UTSJSONObject, field: UTSJSONObject) : boolean {
...
function visibleFields(item: UTSJSONObject) : UTSJSONObject[] {
...
function handleMenu(item: UTSJSONObject) {
	const actions = itemMenuActions(item)
	if (actions.length == 0) {
		return
	}
...
function handleBatchMenuAction(action: UTSJSONObject) {
	batchActionMenuVisible.value = false
	handleBatchAction(action)
}

function batchMenuActionClass(action: UTSJSONObject): string {
...
function batchMenuActionTextClass(action: UTSJSONObject): string {
	if (stringValue(action['key']) == 'delete') {
...
const _component_page_container = resolveComponent("page-container")
  ...
  return _cE("view", _uM({ class: "lul-root" }), [
    isTrue(unref(showSummaryBar))
      ? _cE("view", _uM({
          key: 0,
          class: "lul-summary-wrap"
        }), [
          _cE("view", _uM({
            class: "lul-summary-toggle",
            onClick: withModifiers(toggleSummaryExpanded, ["stop"])
          }), [
            _cE("view", _uM({ class: "lul-summary-toggle-main" }), [
              _cE("text", _uM({ class: "lul-summary-toggle-title" }), _tD(props.summaryTitle), 1 /* TEXT */)
            ]),
            _cE("text", _uM({ class: "lul-summary-toggle-arrow" }), _tD(unref(summaryArrowText)), 1 /* TEXT */)
          ]),
          isTrue(unref(summaryExpanded))
            ? _cE("view", _uM({
                key: 0,
                class: "lul-summary-panel"
              }), [
                _cE(Fragment, null, RenderHelpers.renderList(props.summaryItems, (summaryItem, summaryIndex, __index, _cached): any => {
                  return _cE("view", _uM({
                    key: summaryItemKey(summaryItem, summaryIndex),
                    class: "lul-summary-item"
                  }), [
                    _cE("text", _uM({ class: "lul-summary-item-label" }), _tD(summaryItemLabel(summaryItem)), 1 /* TEXT */),
                    _cE("text", _uM({ class: "lul-summary-item-value" }), _tD(summaryItemValue(summaryItem)), 1 /* TEXT */)
                  ])
                }), 128 /* KEYED_FRAGMENT */)
              ])
            : _cC("v-if", true)
                ...
                _cE("view", _uM({ class: "lul-card-top" }), [
                  ...
                  _ctx.fields.length > 0
                    ? _cE("view", _uM({
                        ...
                        _cE(Fragment, null, RenderHelpers.renderList(visibleFields(item), (field, fieldIndex, __index, _cached): any => {
                          return _cE("view", _uM({
              ...
              _cE("view", _uM({ class: "lul-batch-actions" }), [
                props.batchActions.length > 0
                  ? _cE("view", _uM({
                      ...
                      onClick: openBatchActionMenu
                    }), [
                      _cE("text", _uM({ class: "lul-batch-action-text" }), "操作")
                    ])
                  : _cC("v-if", true),
                _cE("view", _uM({
    ...
    _cV(_component_page_container, _uM({
      show: unref(batchActionMenuVisible),
      position: "bottom",
      round: true,
      overlay: true,
      duration: 240,
      ...
      onClickoverlay: closeBatchActionMenu
    }), _uM({
      default: withSlotCtx((): any[] => [
        _cE("view", _uM({ class: "lul-batch-menu-panel" }), [
          _cE("view", _uM({ class: "lul-batch-menu-handle" })),
          _cE("view", _uM({ class: "lul-batch-menu-head" }), [
            _cE("view", null, [
              _cE("text", _uM({ class: "lul-batch-menu-title" }), "批量操作"),
              _cE("text", _uM({ class: "lul-batch-menu-subtitle" }), _tD(unref(batchInfoText)), 1 /* TEXT */)
            ]),
            _cE("view", _uM({
              class: "lul-batch-menu-close",
              onClick: closeBatchActionMenu
            }), [
              _cE("text", _uM({ class: "lul-batch-menu-close-text" }), "关闭")
            ])
          ]),
          _cE(Fragment, null, RenderHelpers.renderList(props.batchActions, (action, actionIndex, __index, _cached): any => {
            return _cE("view", _uM({
              ...
              class: _nC(batchMenuActionClass(action)),
              onClick: () => {handleBatchMenuAction(action)}
            }), [
              _cE("text", _uM({
                class: _nC(batchMenuActionTextClass(action))
              }), _tD(actionText(action)), 3 /* TEXT, CLASS */)
