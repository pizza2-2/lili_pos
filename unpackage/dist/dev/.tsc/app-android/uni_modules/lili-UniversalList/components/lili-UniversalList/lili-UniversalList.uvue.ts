...
type Props = { __$originalPosition?: UTSSourceMapPosition<"Props", "uni_modules/lili-UniversalList/components/lili-UniversalList/lili-UniversalList.uvue", 120, 6>;
	items?: UTSJSONObject[]
	keyField?: string
	titleField?: string
...
const __sfc__ = defineComponent({
  ...
  emits: ["item-click", "action", "update:selectedItems", "selection-change", "image-preview", "preview-close", "menu", "page-change", "subtitle-click", "field-click", "meta-click"],
  setup(__props) {
