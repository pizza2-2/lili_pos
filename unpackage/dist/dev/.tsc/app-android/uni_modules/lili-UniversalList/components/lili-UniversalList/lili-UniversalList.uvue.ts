...
type Props = { __$originalPosition?: UTSSourceMapPosition<"Props", "uni_modules/lili-UniversalList/components/lili-UniversalList/lili-UniversalList.uvue", 110, 6>;
	items?: UTSJSONObject[]
	keyField?: string
	titleField?: string
...
const __sfc__ = defineComponent({
  ...
  emits: ["item-click", "action", "update:selectedItems", "selection-change", "image-preview", "preview-close", "menu", "page-change"],
  setup(__props) {
                      ...
                      _cE("view", _uM({ class: "lul-headline-row" }), [
                        _cE("view", _uM({ class: "lul-title-wrap" }), [
                          ...
                          isTrue(_ctx.subtitleField != '' && fieldText(item, _ctx.subtitleField) != '')
                            ? _cE("text", _uM({
                                key: 1,
                                class: "lul-subtitle"
                              }), _tD(fieldText(item, _ctx.subtitleField)), 1 /* TEXT */)
                            : _cC("v-if", true)
                        ]),
                        isTrue(_ctx.showMenu)
                          ? _cE("view", _uM({
                              ...
                              _cE("text", _uM({ class: "lul-menu-icon" }), "⋯")
                            ], 8 /* PROPS */, ["onClick"])
                          : _cC("v-if", true),
