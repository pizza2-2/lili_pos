...
const __sfc__ = defineComponent({
  ...
  props: {
    ...
    valueImage: { type: String, required: false, default: '' },
    ...
    subtitleKey: { type: String, required: false, default: '' },
...
const internalImage = ref<string>(props.valueImage ?? '')
...
function getItemImage(item: UTSJSONObject) : string {
	const key = props.imageKey ?? ''
	if (key == '') return ''
	return fieldLabel(item, key)
}

function getItemSubtitle(item: UTSJSONObject) : string {
	const key = props.subtitleKey ?? ''
	if (key == '') return ''
	return fieldLabel(item, key)
}
...
function handleScanSearch() {
	if (props.disabled) return
	scanCode({
		onlyFromCamera: props.scanOnlyFromCamera,
      ...
      renderSlot(_ctx.$slots, "trigger", {}, (): any[] => [
        _cE("view", _uM({ class: "bs-trigger-default" }), [
          unref(internalImage) != ''
            ? _cE("image", _uM({
                key: 0,
                class: "bs-trigger-image",
                src: unref(internalImage),
                mode: "aspectFill"
              }), null, 8 /* PROPS */, ["src"])
            : _cC("v-if", true),
          _cE("text", _uM({
          ...
          _cE("view", _uM({ class: "bs-search-bar" }), [
            _cE("view", _uM({ class: "bs-search-inner" }), [
              isTrue(_ctx.showScan)
                ? _cE("view", _uM({
                    key: 0,
                    class: "bs-search-scan",
                    onClick: handleScanSearch
                  }), [
                    _cE("image", _uM({
                      class: "bs-search-scan-image",
                      ...
                      return _cE("view", _uM({
                        ...
                        _cE("view", _uM({ class: "bs-item-main" }), [
                          ...
                          getItemImage(row.item) != ''
                            ...
                            : _cC("v-if", true),
                          _cE("view", _uM({ class: "bs-item-texts" }), [
                            _cE("text", _uM({
                            ...
                            getItemSubtitle(row.item) != ''
                              ? _cE("text", _uM({
                                  key: 0,
                                  class: "bs-item-subtitle"
                                }), _tD(getItemSubtitle(row.item)), 1 /* TEXT */)
                              : _cC("v-if", true)
                          ])
                        ]),
