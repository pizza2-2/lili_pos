...
type FilterItem = { __$originalPosition?: UTSSourceMapPosition<"FilterItem", "pages/orders/index.uvue", 95, 6>;
	key: string
	text: string
}
...
function parseErrorMessage(error: any, fallback: string): string {
	...
	if (error != null) {
		...
		if (errorText != null && errorText != '') {
			const parsedError = UTSAndroid.consoleDebugError(JSON.parseObject<UTSJSONObject>(errorText), " at pages/orders/index.uvue:168")
			if (parsedError != null) {
