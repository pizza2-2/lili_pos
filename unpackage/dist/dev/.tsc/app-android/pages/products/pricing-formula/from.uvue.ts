...
type FormulaChoice = { __$originalPosition?: UTSSourceMapPosition<"FormulaChoice", "pages/products/pricing-formula/from.uvue", 168, 6>;
	value: string
	label: string
}

type FormulaStep = { __$originalPosition?: UTSSourceMapPosition<"FormulaStep", "pages/products/pricing-formula/from.uvue", 173, 6>;
	kind: string
	operator: string
	operand: string
	mode: string
...
type ParsedFormula = { __$originalPosition?: UTSSourceMapPosition<"ParsedFormula", "pages/products/pricing-formula/from.uvue", 181, 6>;
	success: boolean
