    ...
    _cE("scroll-view", _uM({
      ...
      _cE("view", _uM({ class: "page-content" }), [
        ...
        _cV(_component_lili_UniversalList, _uM({
          ...
          showFloatingAdd: showFloatingAdd.value,
          floatingAddText: "新增",
          onItemClick: handleItemClick,
          onFieldClick: handleFieldClick,
          onSubtitleClick: handleFieldClick,
          onMetaClick: handleFieldClick,
          onMenu: handleMenu,
          onPageChange: handlePageChange,
          onFloatingAdd: handleCreate
        }), null, 8 /* PROPS */, ["items", "fields", "loading", "loadingText", "inlineLoadingText", "emptyText", "showMenu", "menuActions", "currentPage", "totalPages", "totalCount", "showFloatingAdd"])
      ])
    ])
  ])
}
