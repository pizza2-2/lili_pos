...
type SelectOption = { __$originalPosition?: UTSSourceMapPosition<"SelectOption", "pages/inventory-checks/index.uvue", 141, 6>;
	value: string
	label: string
}
	...
	if (error != null) {
		...
		if (errorText != null && errorText != '') {
			...
			try {
				...
				if (trimmedText != '' && trimmedText.substring(0, 1) == '{') parsedError = UTSAndroid.consoleDebugError(JSON.parseObject<UTSJSONObject>(trimmedText), " at pages/inventory-checks/index.uvue:239")
			} catch (parseError) {
				parsedError = null
			}
			if (parsedError != null) {
...
function buildOptionQuery(params: UTSJSONObject): UTSJSONObject {
	...
	const query = { __$originalPosition: new UTSSourceMapPosition("query", "pages/inventory-checks/index.uvue", 377, 8),  page: pageValue <= 0 ? 1 : pageValue, page_size: pageSizeValue <= 0 ? 50 : pageSizeValue } as UTSJSONObject
