...
type SelectOption = { __$originalPosition?: UTSSourceMapPosition<"SelectOption", "pages/inventory-checks/from.uvue", 15, 6>;
	value: string
	text: string
}
