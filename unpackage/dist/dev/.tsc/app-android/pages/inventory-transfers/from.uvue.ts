  ...
  return _cE("view", _uM({ class: "page" }), [
    ...
    _cE("view", _uM({ class: "page-content" }), [
      _cV(_component_lili_UniversaForm, _uM({
        ...
        "field-transfer_overview": withScopedSlotCtx((slotProps: Record<string, any | null>): any[] => {
        const value = slotProps["value"]
        return [
          _cE("view", _uM({ class: "transfer-card" }), [
            _cE("view", _uM({ class: "transfer-card-head" }), [
              _cE("view", _uM({ class: "transfer-title-wrap" }), [
                _cE("text", _uM({ class: "transfer-title" }), _tD(transferNumberText.value), 1 /* TEXT */),
                _cE("text", _uM({ class: "transfer-subtitle" }), _tD(transferRouteText.value), 1 /* TEXT */)
              ]),
              _cE("text", _uM({ class: "transfer-status" }), _tD(transferStatusText.value), 1 /* TEXT */)
            ]),
            _cE("view", _uM({ class: "transfer-metrics" }), [
              _cE("view", _uM({ class: "transfer-metric" }), [
                _cE("text", _uM({ class: "transfer-metric-label" }), "调拨总数"),
                _cE("text", _uM({ class: "transfer-metric-value" }), _tD(totalQuantityText.value), 1 /* TEXT */)
              ]),
              _cE("view", _uM({ class: "transfer-metric" }), [
                _cE("text", _uM({ class: "transfer-metric-label" }), "已调拨"),
                _cE("text", _uM({ class: "transfer-metric-value" }), _tD(transferredQuantityText.value), 1 /* TEXT */)
              ]),
              _cE("view", _uM({ class: "transfer-metric transfer-metric-last" }), [
                _cE("text", _uM({ class: "transfer-metric-label" }), "明细数"),
                _cE("text", _uM({ class: "transfer-metric-value" }), _tD(itemsCountText.value), 1 /* TEXT */)
              ])
            ])
          ])
        ]}),
        _: 1 /* STABLE */
      }), 8 /* PROPS */, ["mode", "formSections", "initialData", "leaveSignal"])
    ])
  ])
}
}
...
const GenPagesInventoryTransfersFromStyles = [_uM([["page", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["backgroundColor", "#EEF2F7"]]))], ["page-content", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["paddingBottom", 0]]))], ["transfer-card", _pS(_uM([["backgroundColor", "#FFFFFF"], ["borderTopWidth", 1], ["borderRightWidth", 1], ["borderBottomWidth", 1], ["borderLeftWidth", 1], ["borderTopStyle", "solid"], ["borderRightStyle", "solid"], ["borderBottomStyle", "solid"], ["borderLeftStyle", "solid"], ["borderTopColor", "#E2E8F0"], ["borderRightColor", "#E2E8F0"], ["borderBottomColor", "#E2E8F0"], ["borderLeftColor", "#E2E8F0"], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8], ["paddingTop", 12], ["paddingRight", 12], ["paddingBottom", 12], ["paddingLeft", 12]]))], ["transfer-card-head", _pS(_uM([["flexDirection", "row"], ["alignItems", "flex-start"], ["justifyContent", "space-between"]]))], ["transfer-title-wrap", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["paddingRight", 8]]))], ["transfer-title", _pS(_uM([["fontSize", 16], ["lineHeight", "22px"], ["color", "#0F172A"], ["fontWeight", "bold"]]))], ["transfer-subtitle", _pS(_uM([["marginTop", 3], ["fontSize", 12], ["lineHeight", "17px"], ["color", "#475569"]]))], ["transfer-status", _pS(_uM([["height", 24], ["lineHeight", "24px"], ["paddingLeft", 8], ["paddingRight", 8], ["borderTopLeftRadius", 12], ["borderTopRightRadius", 12], ["borderBottomRightRadius", 12], ["borderBottomLeftRadius", 12], ["backgroundColor", "#E0F2FE"], ["color", "#0369A1"], ["fontSize", 11], ["fontWeight", "bold"]]))], ["transfer-metrics", _pS(_uM([["flexDirection", "row"], ["marginTop", 12]]))], ["transfer-metric", _pS(_uM([["flexGrow", 1], ["flexShrink", 1], ["flexBasis", "0%"], ["minHeight", 54], ["borderTopLeftRadius", 8], ["borderTopRightRadius", 8], ["borderBottomRightRadius", 8], ["borderBottomLeftRadius", 8], ["backgroundColor", "#F8FAFC"], ["alignItems", "center"], ["justifyContent", "center"], ["marginRight", 6]]))], ["transfer-metric-last", _pS(_uM([["marginRight", 0]]))], ["transfer-metric-label", _pS(_uM([["fontSize", 11], ["lineHeight", "15px"], ["color", "#64748B"]]))], ["transfer-metric-value", _pS(_uM([["marginTop", 4], ["fontSize", 18], ["lineHeight", "24px"], ["color", "#0F172A"], ["fontWeight", "bold"]]))]])]
