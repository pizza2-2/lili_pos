...
function parseErrorMessage(error: any, fallback: string): string {
	...
	if (error != null) {
		...
		if (errorText != null && errorText != '') {
			const parsedError = UTSAndroid.consoleDebugError(JSON.parseObject<UTSJSONObject>(errorText), " at pages/purchases/index.uvue:109")
			if (parsedError != null) {
...
function handleCreate(payload: UTSJSONObject) { uni.navigateTo({ url: '/pages/purchases/from' }) }
