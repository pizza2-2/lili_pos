...
const groups = ref<MenuGroup[]>([
	{
		...
		rows: [
			[
				{ label: '供应商', icon: '', iconPath: '/static/muen/供应商.png', path: '/pages/suppliers/index', action: 'navigateTo', disabled: false },
				{ label: '商店', icon: '', iconPath: '/static/muen/商店.png', path: '/pages/shop/index', action: 'navigateTo', disabled: false },
			],
		],
	},
	{
