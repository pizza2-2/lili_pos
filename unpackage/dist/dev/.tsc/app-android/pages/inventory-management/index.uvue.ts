  ...
  return _cE("view", _uM({ class: "page" }), [
    _cV(_component_lili_universal_filter, _uM({
      ...
      "filter-panel": withSlotCtx((): any[] => [
        _cE("view", _uM({
          ...
          _cE("scroll-view", _uM({
            "scroll-y": "true",
            class: "inventory-filter-content-scroll",
            style: _nS(filterContentScrollStyle.value)
          }), [
            _cE("view", _uM({ class: "inventory-filter-scroll-inner" }), [
              _cE("view", _uM({ class: "inventory-filter-select-group" }), [
                _cE("text", _uM({ class: "inventory-filter-select-title" }), "供应商"),
                _cE("view", _uM({ class: "inventory-filter-select-wrap" }), [
                  _cV(unref(liliBottomSelect), _uM({
                    value: unref(draftSupplierValue),
                    valueText: unref(draftSupplierText),
                    title: "选择供应商",
                    placeholder: "全部供应商",
              ...
              _cE("view", _uM({ class: "inventory-filter-select-group" }), [
                _cE("text", _uM({ class: "inventory-filter-select-title" }), "分类"),
                _cE("view", _uM({ class: "inventory-filter-select-wrap" }), [
                  _cV(unref(liliBottomSelect), _uM({
                    values: unref(draftCategoryValues),
                    title: "选择分类",
                    placeholder: "全部分类",
              ...
              _cE("view", _uM({ class: "inventory-filter-select-group" }), [
                _cE("text", _uM({ class: "inventory-filter-select-title" }), "库存位置"),
                _cE("view", _uM({ class: "inventory-filter-select-wrap" }), [
                  _cV(unref(liliBottomSelect), _uM({
              ...
              _cE("view", _uM({ class: "inventory-filter-group" }), [
                _cE("text", _uM({ class: "inventory-filter-group-title" }), "预警状态"),
                _cE("view", _uM({ class: "inventory-filter-options" }), [
                  _cE(Fragment, null, RenderHelpers.renderList(alertStatusOptions, (option, __key, __index, _cached): any => {
                    return _cE("view", _uM({
                      key: 'alert-' + option.value,
                      class: _nC(unref(draftAlertStatus) == option.value ? 'inventory-filter-option inventory-filter-option-active' : 'inventory-filter-option'),
                      onClick: () => {selectAlertStatus(option.value)}
                    }), [
                      _cE("text", _uM({
                        class: _nC(unref(draftAlertStatus) == option.value ? 'inventory-filter-option-text inventory-filter-option-text-active' : 'inventory-filter-option-text')
              ...
              _cE("view", _uM({ class: "inventory-filter-group" }), [
                _cE("text", _uM({ class: "inventory-filter-group-title" }), "上架状态"),
                _cE("view", _uM({ class: "inventory-filter-options" }), [
                  _cE(Fragment, null, RenderHelpers.renderList(listedStatusOptions, (option, __key, __index, _cached): any => {
                    return _cE("view", _uM({
                      key: 'listed-' + option.value,
                      class: _nC(unref(draftListedStatus) == option.value ? 'inventory-filter-option inventory-filter-option-active' : 'inventory-filter-option'),
                      onClick: () => {selectListedStatus(option.value)}
                    }), [
                      _cE("text", _uM({
                        class: _nC(unref(draftListedStatus) == option.value ? 'inventory-filter-option-text inventory-filter-option-text-active' : 'inventory-filter-option-text')
                      }), _tD(option.label), 3 /* TEXT, CLASS */)
                    ], 10 /* CLASS, PROPS */, ["onClick"])
                  }), 64 /* STABLE_FRAGMENT */)
                ])
    ...
    _cE("scroll-view", _uM({
      ...
      _cE("view", _uM({ class: "page-content" }), [
        isTrue(productMode.value)
          ? _cE("view", _uM({
              key: 0,
              class: "product-stock-header"
            }), [
              ...
              _cE("view", _uM({
                ...
                _cE("text", _uM({ class: "product-stock-action-text" }), "新增库存")
              ])
            ])
          : _cC("v-if", true),
