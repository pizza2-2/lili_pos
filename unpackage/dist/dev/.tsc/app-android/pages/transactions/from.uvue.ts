...
type SelectOption = { __$originalPosition?: UTSSourceMapPosition<"SelectOption", "pages/transactions/from.uvue", 52, 6>;
	value: string
	text: string
}
...
function buildUploadHeaders() : UTSJSONObject {
	const headers = { __$originalPosition: new UTSSourceMapPosition("headers", "pages/transactions/from.uvue", 94, 8), } as UTSJSONObject
	if (authState.token != '') {
