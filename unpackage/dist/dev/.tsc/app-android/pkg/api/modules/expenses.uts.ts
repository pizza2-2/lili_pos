...
function buildExpenseListQuery(data: ExpenseListQuery): UTSJSONObject {
	...
	if (data.expenditure_type != null && data.expenditure_type != '') query['expenditure_type'] = data.expenditure_type
	if (data.expenditure_type_id != null && data.expenditure_type_id != '') query['expenditure_type_id'] = data.expenditure_type_id
	if (data.supplier != null && data.supplier != '') query['supplier'] = data.supplier
	if (data.supplier_id != null && data.supplier_id != '') query['supplier_id'] = data.supplier_id
	...
	if (data.amount_min != null && data.amount_min != '') query['amount_min'] = data.amount_min
	if (data.amount_max != null && data.amount_max != '') query['amount_max'] = data.amount_max
	return query
}
...
export function buildExpenseListResponse(raw: any, query: ExpenseListQuery): ExpenseListResponse {
	...
	if (rawPagination != null) {
		...
		if (paginationText != null && paginationText != '') paginationObject = JSON.parseObject<UTSJSONObject>(paginationText)
	}
...
function buildMutationBody(data: ExpenseMutationData): UTSJSONObject {
	...
	if (data.expenditure_type_id != null && data.expenditure_type_id != '') body['expenditure_type_id'] = parseInt(data.expenditure_type_id)
	else body['expenditure_type_id'] = null
	if (data.supplier_id != null && data.supplier_id != '') body['supplier_id'] = parseInt(data.supplier_id)
