    ...
    companion object {
        ...
        var setup: (__props: GenUniModulesLiliBottomSelectComponentsLiliBottomSelectLiliBottomSelect, __setupCtx: SetupContext) -> Any? = fun(__props, __setupCtx): Any? {
            ...
            fun buildFetchParams(page: Number, keywordValue: String, id: String, parent: String = ""): UTSJSONObject {
                val params: UTSJSONObject = _uO("page" to page, "pageSize" to props.pageSize, "keyword" to keywordValue, "id" to id)
                if (parent != "") {
        ...
        ), "multiple" to _uM("type" to "Boolean", "required" to false, "default" to false), "tree" to _uM("type" to "Boolean", "required" to false, "default" to false), "childrenKey" to _uM("type" to "String", "required" to false, "default" to "children"), "defaultExpandAll" to _uM("type" to "Boolean", "required" to false, "default" to false), "expandOnClickNode" to _uM("type" to "Boolean", "required" to false, "default" to false), "checkStrictly" to _uM("type" to "Boolean", "required" to false, "default" to true), "accordion" to _uM("type" to "Boolean", "required" to false, "default" to false), "selectableLevel" to _uM("type" to "Number", "required" to false, "default" to -1), "selectableLevelMessage" to _uM("type" to "String", "required" to false, "default" to ""), "placeholder" to _uM("type" to "String", "required" to false, "default" to "请选择"), "title" to _uM("type" to "String", "required" to false, "default" to "请选择"), "searchPlaceholder" to _uM("type" to "String", "required" to false, "default" to "请输入关键词搜索"), "emptyText" to _uM("type" to "String", "required" to false, "default" to "暂无数据"), "disabled" to _uM("type" to "Boolean", "required" to false, "default" to false), "labelKey" to _uM("type" to "String", "required" to false, "default" to "text"), "valueKey" to _uM("type" to "String", "required" to false, "default" to "value"), "pageSize" to _uM("type" to "Number", "required" to false, "default" to 20), "searchDelay" to _uM("type" to "Number", "required" to false, "default" to 300), "closeOnOverlay" to _uM("type" to "Boolean", "required" to false, "default" to true), "showEditAction" to _uM("type" to "Boolean", "required" to false, "default" to true), "showAddAction" to _uM("type" to "Boolean", "required" to false, "default" to true), "showScan" to _uM("type" to "Boolean", "required" to false, "default" to false), "scanOnlyFromCamera" to _uM("type" to "Boolean", "required" to false, "default" to true), "editActionText" to _uM("type" to "String", "required" to false, "default" to "编辑"), "addActionText" to _uM("type" to "String", "required" to false, "default" to "新增"), "editPath" to _uM("type" to "String", "required" to false, "default" to ""), "addPath" to _uM("type" to "String", "required" to false, "default" to ""), "editQueryKey" to _uM("type" to "String", "required" to false, "default" to "id")))
