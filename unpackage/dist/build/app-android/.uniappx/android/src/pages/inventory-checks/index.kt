...
open class GenPagesInventoryChecksIndex : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesInventoryChecksIndex) -> Any? = fun(__props): Any? {
            ...
            val menuActions = ref(_uA<UTSJSONObject>(_uO("key" to "edit", "text" to "编辑"), _uO("key" to "start-check", "text" to "开始"), _uO("key" to "submit-check", "text" to "提交"), _uO("key" to "approve-check", "text" to "审核"), _uO("key" to "adjust-check", "text" to "调整库存"), _uO("key" to "reload", "text" to "刷新")))
            ...
            fun gen_handleCreate_fn() {
                uni_navigateTo(NavigateToOptions(url = "/pages/inventory-checks/from"))
            }
                ...
                return _cE("view", _uM("class" to "page"), _uA(
                    ...
                    _cE("scroll-view", _uM("style" to _nS(_uM("flex" to "1")), "class" to "page-scroll"), _uA(
                        _cE("view", _uM("class" to "page-content"), _uA(
                            ...
                            ,
                            _cV(_component_lili_UniversalList, _uM("items" to listItems.value, "keyField" to "id", "titleField" to "name", "subtitleField" to "subtitle", "metaField" to "meta", "tagField" to "tags", "fields" to unref(fieldConfig), "loading" to unref(isLoading), "loadingText" to "正在加载盘点单", "emptyText" to emptyText.value, "emptyIcon" to "◎", "showMenu" to true, "menuActions" to unref(menuActions), "showPagination" to true, "currentPage" to unref(currentPage), "totalPages" to unref(totalPages), "totalCount" to unref(totalCount), "summaryTitle" to "盘点概览", "summaryItems" to summaryItems.value, "showFloatingAdd" to true, "floatingAddText" to "新增", "onMenu" to handleMenu, "onPageChange" to handlePageChange, "onFloatingAdd" to handleCreate), null, 8, _uA(
                                "items",
                                "fields",
                                "loading",
                                "emptyText",
