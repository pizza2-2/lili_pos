...
open class GenPagesInventoryTransfersIndex : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesInventoryTransfersIndex) -> Any? = fun(__props): Any? {
            ...
            val menuActions = ref(_uA<UTSJSONObject>(_uO("key" to "edit", "text" to "编辑"), _uO("key" to "approve-transfer", "text" to "审核"), _uO("key" to "complete-transfer", "text" to "完成"), _uO("key" to "cancel-transfer", "text" to "取消"), _uO("key" to "reload", "text" to "刷新")))
            ...
            fun gen_loadItems_fn(): UTSPromise<Unit> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        try {
                            ...
                            , page = currentPage.value, page_size = pageSize.value, status = null, alert_status = null, transaction_type = null, location_type = null, is_active = null)
            ...
            fun gen_handleMenu_fn(payload: UTSJSONObject) {
                ...
                } else if (actionKey == "approve-transfer") {
            ...
            fun gen_handleCreate_fn() {
                uni_navigateTo(NavigateToOptions(url = "/pages/inventory-transfers/from"))
            }
                ...
                return _cE("view", _uM("class" to "page"), _uA(
                    ...
                    _cE("scroll-view", _uM("style" to _nS(_uM("flex" to "1")), "class" to "page-scroll"), _uA(
                        _cE("view", _uM("class" to "page-content"), _uA(
                            ...
                            ,
                            _cV(_component_lili_UniversalList, _uM("items" to listItems.value, "keyField" to "id", "titleField" to "name", "subtitleField" to "subtitle", "metaField" to "meta", "tagField" to "tags", "fields" to unref(fieldConfig), "loading" to unref(isLoading), "loadingText" to "正在加载调拨单", "emptyText" to emptyText.value, "emptyIcon" to "◎", "showMenu" to true, "menuActions" to unref(menuActions), "showPagination" to true, "currentPage" to unref(currentPage), "totalPages" to unref(totalPages), "totalCount" to unref(totalCount), "summaryTitle" to "调拨概览", "summaryItems" to summaryItems.value, "showFloatingAdd" to true, "floatingAddText" to "新增", "onMenu" to handleMenu, "onPageChange" to handlePageChange, "onFloatingAdd" to handleCreate), null, 8, _uA(
                                "items",
                                "fields",
                                "loading",
                                "emptyText",
