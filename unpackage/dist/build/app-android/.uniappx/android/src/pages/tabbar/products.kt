...
open class GenPagesTabbarProducts : BasePage {
    ...
    companion object {
        ...
        var setup: (__props: GenPagesTabbarProducts) -> Any? = fun(__props): Any? {
            ...
            val menuActions = ref(_uA<UTSJSONObject>(_uO("key" to "detail", "text" to "详情"), _uO("key" to "reload", "text" to "刷新")))
            ...
            fun gen_fetchCategoryFilterOptions_fn(params: UTSJSONObject): UTSPromise<UTSJSONObject> {
                return wrapUTSPromise(suspend w1@{
                        ...
                        val queryParams: UTSJSONObject = _uO("key" to "parent", "page" to parseInt(if (pageValue == "") {
                            "1"
                        } else {
                            pageValue
                        }
