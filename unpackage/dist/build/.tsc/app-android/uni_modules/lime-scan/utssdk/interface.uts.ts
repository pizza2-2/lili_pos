...
export type ScanType =
	...
	| 'WX_CODE'
	| 'CODE_25'
export type ScanFormatTypeCode = 'barCode' | 'codabar' | 'code39' | 'code93' | 'code128' | 'datamatrix' | 'dataMatrix' | 'ean8' | 'ean13' | 'itf' | 'upcA' | 'upcE' | 'pdf417' | 'qrCode' | 'aztec' 	
...
export interface ScanCodeSuccessCallbackResult {
	/** 所扫码的字符集 */
	charSet : string
...
export type ScanCodeOption = {
	...
	scanType ?: Array<ScanFormatTypeCode>
	/** 接口调用成功的回调函数 */
	success ?: ScanCodeSuccessCallback
	scanMode?: 'multiProcessor' | 'default' | 'custom'
	/**
	 * 是否开启连续扫码模式
	 */
...
export type CreateQRCodeallback = (
	result : string
) => void 
...
export type CreateQRCodeOptions = {
	...
	height?: number
	width?: number
	complete?: CreateQRCodeallback
	success?: CreateQRCodeallback
	fail?: CreateQRCodeallback
}
