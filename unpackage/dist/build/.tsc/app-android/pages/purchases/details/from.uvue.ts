...
const formSections = ref<UTSJSONObject[]>([
	{
		...
		defaultOpen: true,
		fields: [
			{ key: 'product', textKey: 'product_text', label: '商品', type: 'bottomSelect', required: true, title: '选择商品', placeholder: '请选择商品', searchPlaceholder: '扫码或输入商品名/条码', showScan: true, showAddAction: true, showEditAction: true, addPath: '/pages/products/from', editPath: '/pages/products/from', fetchData: fetchProductOptions } as UTSJSONObject,
