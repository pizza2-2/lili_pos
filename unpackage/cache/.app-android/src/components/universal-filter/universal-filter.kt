...
open class GenComponentsUniversalFilterUniversalFilter : VueComponent {
    ...
    companion object {
        ...
        var setup: (__props: GenComponentsUniversalFilterUniversalFilter) -> Any? = fun(__props): Any? {
            val __ins = getCurrentInstance()!!
            val _ctx = __ins.proxy as GenComponentsUniversalFilterUniversalFilter
            ...
            fun gen_onSearchInput_fn(e: UTSJSONObject) {
                val value = eventValueToString(e)
                        ...
                        if (isTrue(_ctx.showSearch)) {
                            _cE("view", _uM("key" to 1, "class" to "uf-search-wrap"), _uA(
                                _cE("view", _uM("class" to "uf-search-box"), _uA(
                                    ...
                                    _cE("input", _uM("class" to "uf-search-input", "value" to unref(inputValue), "placeholder" to _ctx.searchPlaceholder, "onInput" to onSearchInput, "onConfirm" to onSearchConfirm, "confirm-type" to "search"), null, 40, _uA(
                                        "value",
                                        "placeholder"
                                    )),
                                    if (unref(inputValue) != "") {
