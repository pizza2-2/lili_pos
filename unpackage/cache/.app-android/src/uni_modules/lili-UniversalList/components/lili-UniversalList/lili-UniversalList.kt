...
open class GenUniModulesLiliUniversalListComponentsLiliUniversalListLiliUniversalList : VueComponent {
    ...
    companion object {
            ...
            return fun(): Any? {
                ...
                return _cE("view", _uM("class" to "lul-root"), _uA(
                    ...
                    if (isTrue(unref(previewVisible))) {
                        _cV(_component_lili_preview, _uM("key" to 3, "images" to unref(previewImages), "initialIndex" to unref(previewIndex), "visible" to unref(previewVisible), "showList" to false, "enableSave" to _ctx.enablePreviewSave, "enableShare" to _ctx.enablePreviewShare, "onUpdate:visible" to handlePreviewVisibleChange, "onUpdate:index" to handlePreviewIndexChange, "onPreview" to handlePreviewOpen, "onClose" to handlePreviewClose), null, 8, _uA(
                            "images",
                            "initialIndex",
                            "visible",
                            "enableSave",
                    ...
                    if (isTrue(props.showFloatingAdd)) {
                        _cE("view", _uM("key" to 4, "class" to "lul-floating-add", "onClick" to handleFloatingAdd), _uA(
        ...
        ), "showPagination" to _uM("type" to "Boolean", "required" to false, "default" to false), "currentPage" to _uM("type" to "Number", "required" to false, "default" to 1), "totalPages" to _uM("type" to "Number", "required" to false, "default" to 1), "totalCount" to _uM("type" to "Number", "required" to false, "default" to 0), "showFloatingAdd" to _uM("type" to "Boolean", "required" to false, "default" to false), "floatingAddText" to _uM("type" to "String", "required" to false, "default" to "新增"), "enablePreviewSave" to _uM("type" to "Boolean", "required" to false, "default" to true), "enablePreviewShare" to _uM("type" to "Boolean", "required" to false, "default" to true)))
